...
for i in np.linspace(0,3, 50):
	...
	main.main(a, b, e, cost_fn=cost_fn, save_to=fr'C:\Users\Yuman\Desktop\Programmeren\bachelorproject\wasserstein_distance\animation_frames\varying cost function exponential\2\\{i:.3f}.png')