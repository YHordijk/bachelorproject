...
def main(a, b, epsilon=0.1, converge_thresh=10**-15, save_to=None, cost_fn=None, error_fn=None):
	### CALCULATION
	#get coupling matrix and errors
	W, P, error_a, error_b, bc_map = sink.sinkhorn(a, b, epsilon, converge_thresh=converge_thresh, cost_fn=cost_fn, error_fn=error_fn)
...
if __name__ == '__main__':
	...
	main(a, b, epsilon=epsilon, cost_fn=cost_fn, error_fn=error_fn, save_to=save_to)